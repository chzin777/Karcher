...
export default function ContactForm() {
  ...
  const handleSubmit = async (data: ContactFormData) => {
    try {
      ...
      // 👉 Criar payload formatado para o N8N
      const payload = {
        firstName,
        lastName,
        email: data.email,
    ...
    <div className="flex items-center justify-center w-full px-4">
      <Form {...form}>
        <form
          ...
          className="space-y-8 w-full max-w-3xl px-6 sm:px-12 py-12 sm:py-20 lg:px-20 lg:py-24 bg-white/15 backdrop-blur-lg shadow-xl rounded-3xl text-white border border-white/50 text-base sm:text-2xl"
        >
          {/* Logo */}
          ...
          <Button
            type="submit"
            className="w-full bg-[#219fda] text-white text-base sm:text-xl py-4 sm:py-6 mt-4"
          >
